      ...
      <div className="bg-white py-2">
        <div className>
          <Grid container spacing={2}>
            <Grid item xs={2}>
              <Sidebar />
              <div className="controls mt-4 px-2">
  <div className="flex flex-col sm:flex-row gap-2">
    <button
      onClick={() => onLayout("TB")}
      className="px-2 py-1 sm:px-3 sm:py-2 text-xs sm:text-sm md:text-base w-full sm:w-auto text-center text-black border border-black rounded hover:bg-black hover:text-white active:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 transition duration-150 ease-in-out"
    >
      Vertical layout
    </button>
    <button
    ...
    >
      Horizontal layout
            ...
            <Grid ref={flowImageDownloadRef} item xs={10}>
              <div
                className=" bg-indigo-50 rounded-md my-1 mx-2 border-2 border-indigo-200"
